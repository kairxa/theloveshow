...
/******/ 	__webpack_require__.p = "dist/assets/javascripts/";
/******/
...
/***/ function(module, exports, __webpack_require__) {
	...
	var TitleBar_1 = __webpack_require__(168);
	var DialogBox_1 = __webpack_require__(169);
	var MemberBox_1 = __webpack_require__(177);
	var Settings_1 = __webpack_require__(178);
	var STYLES = {
	    container: {
	        display: 'flex',
	        minHeight: '100vh',
	...
	ReactDOM.render(React.createElement(LoveShow, null), document.querySelector('#theloveshow'));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ChatBox_1 = __webpack_require__(170);
	var InputBox_1 = __webpack_require__(176);
	var STYLES = {
	    container: {
	        display: 'flex',
	...
	var DialogBox = (function (_super) {
	    ...
	    DialogBox.prototype.handleInputSubmit = function (chatStructure) {
	        if (this.state.dialogList.length === 0) {
	            ...
	            var lastDialog = Object.assign({}, this.state.dialogList[this.state.dialogList.length - 1]);
	            if (chatStructure.actor === lastDialog.actor) {
	                lastDialog.chat = lastDialog.chat.concat(chatStructure.chat);
	                var modifiedDialogList = this.state.dialogList.slice();
	                ...
	                this.setState({
	                    dialogList: this.state.dialogList.concat([chatStructure])
	                });
	            }
	        }
	    };
	    DialogBox.prototype.render = function () {
	        return (React.createElement("section", {style: STYLES.container}, React.createElement(ChatBox_1.default, {dialogList: this.state.dialogList}), React.createElement(InputBox_1.default, {onSubmit: this.handleInputSubmit.bind(this)})));
	    };
	    return DialogBox;
	}(React.Component));
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var ChatDisplay_1 = __webpack_require__(171);
	var STYLES = {
	    container: {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(1);
	var Members = __webpack_require__(172);
	var STYLES = {
	    container: {
	        margin: '0 20px',
	...
	var ChatDisplay = (function (_super) {
	    __extends(ChatDisplay, _super);
	    function ChatDisplay() {
	        _super.apply(this, arguments);
	    }
	    ChatDisplay.prototype.render = function () {
	        return (React.createElement("div", {style: STYLES.container}, React.createElement("div", {style: Members.getAvatar(STYLES.avatar, this.props.actor)}), React.createElement("div", {style: STYLES.display}, React.createElement("div", null, React.createElement("span", {style: Members.getStyle(this.props.actor)}, this.props.actor), React.createElement("span", {style: STYLES.says}, "says:")), this.props.chat.map(function (chat, key) {
	            return (React.createElement("div", {style: STYLES.text, key: key}, chat));
	        }))));
	    };
	    return ChatDisplay;
	}(React.Component));
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var KAIRXA_AVATAR_PATH = __webpack_require__(173);
	var ELRIX_AVATAR_PATH = __webpack_require__(174);
	var ZLX_AVATAR_PATH = __webpack_require__(175);
	function getAvatar(generic, actor) {
	    var avatarPath;
	    switch (actor) {
	        case 'zlaxxar':
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "2vpk6Tx.JPG";

/***/ },
/* 174 */
/***/ function(module, exports, __webpack_require__) {

	module.exports = __webpack_require__.p + "t7YQqK2.JPG";
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InputBox = (function (_super) {
	    ...
	    InputBox.prototype.handleInputChange = function (event) {
	        this.setState({
	    ...
	    InputBox.prototype.render = function () {
	        return (React.createElement("form", {style: STYLES.container, onSubmit: this.handleFormSubmit.bind(this)}, React.createElement("input", {type: "text", value: this.state.input, style: STYLES.input, placeholder: "Chat in theloveshow...", onChange: this.handleInputChange.bind(this)})));
	    };
	    return InputBox;
	}(React.Component));
	Object.defineProperty(exports, "__esModule", { value: true });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Settings = (function (_super) {
	    ...
	    Settings.prototype.handleToggleSettings = function () {
...
/***/ }
/******/ ]);
//# sourceMappingURL=theloveshow.js.map